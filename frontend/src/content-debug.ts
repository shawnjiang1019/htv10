...
async function injectPopup() {
  console.log("YouTube Transcript AI: Running on", window.location.href);

  if (window.location.hostname !== "www.youtube.com") {
    console.log("YouTube Transcript AI: Not on YouTube");
    return;
  }

  if (!window.location.pathname.startsWith("/watch")) {
    console.log("YouTube Transcript AI: Not a video page");
    return;
  }
  ...
  try {
    ...
    if (!document.getElementById("youtube-transcript-test")) {
      ...
      console.log("YouTube Transcript AI: Popup injected in #secondary");
    ...
    console.warn("YouTube Transcript AI:", err);
